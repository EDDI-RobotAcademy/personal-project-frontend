<template>
  <v-container>
    <nav>
      <router-link class="complete" to="/account-register-page">회원 계정 등록</router-link> |
      ...
      <router-link to="/account-shop-page">샾 page</router-link> |
      ...
      <router-link to="/manager-notice-page">관리자용 공지사항 page</router-link> |
