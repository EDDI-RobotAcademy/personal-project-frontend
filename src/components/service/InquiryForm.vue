    ...
    <form class="inquiry-form" @submit.prevent="submitInquiry">
      ...
      <ul class="inquiry-form__list">
        ...
        <li class="inquiry-form__item">
          ...
          <textarea name="content" type="content" class="item__textarea" placeholder="내용을 입력하세요."
        ...
        <li class="inquiry-form__item">
          ...
          <div class="item__uploader">
            <div class="item__uploader__input">
              <AIcon type="camera" />
              <input type="file" accept="image/png, image/jpeg, image/jpg" id="inquriy__file" style="display: none" />
            </div>
    ...
    .inquiry-form__list {
      ...
      .inquiry-form__item {
        ...
        #inquiry-type-select {
          ...
          background: url('~@/assets/select_arrow.svg') right 8px center / 10px 6px no-repeat rgb(255, 255, 255);
          outline: none;
          font-size: 14px;
          font-weight: 300;
          color: rgb(76, 76, 76);
