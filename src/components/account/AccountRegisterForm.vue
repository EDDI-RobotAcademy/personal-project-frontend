                ...
                <v-card width="460" style="background-color: rgba(255, 255, 255, 0.8);">
                    <v-card-text class="text-center px-12 py-16" style="margin-top: 75px;">
                        <v-form @submit.prevent="registAccount" ref="form">
                            <div style="margin-bottom: 55px; margin-top: -25px; font-size: 38px;">회원 가입
                                <v-divider style="margin-top: 16px;"></v-divider>
                            </div>
                            <div class="d-flex">
                                <v-text-field v-model="email" label="이메일" :rules="email_rule" :disabled="false" required>
                                </v-text-field>
                                <v-btn text large outlined style="font-size: 13px" class="mt-3 ml-5" color="brown"
