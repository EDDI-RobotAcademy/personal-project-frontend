<template>
  <div class="terms-form">
    ...
    <h2 class="terms-form__desc">
      환영합니다! Room Story 서비스 이용약관에 동의해주세요.
    </h2>
    <div class="terms-form__all-check-btn">
      <input type="checkbox" id="terms-all-check" v-model="allChecked" @click="checkAllTerms" />
    ...
    <div class="terms-form__terms-group">
      ...
      <div class="terms-group__term">
        <div class="term__input">
          <input type="checkbox" id="term-service-check" v-model="serviceTermStatus" />
          <label for="term-service-check">
            [필수] Room Story 서비스 이용약관 동의
          </label>
        </div>
        <a href="#" target="_blank">
          <a-icon type="right" />
      ...
      <div class="terms-group__term">
        <div class="term__input">
          <input type="checkbox" id="term-info-check" v-model="infoTermStatus" />
    ...
    <button class="terms-form__submit-btn" @click="submitTerms" :disabled="!isCheckedTerms">
      동의하고 진행하기
    </button>
  </div>
</template>
